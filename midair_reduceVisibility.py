...
def main():
    ...
    if reduction == 1:
        ...
        1. small (20% visibility reduced) 
        2. middle (40% visibility reduced)
        3. middle disspersed (40% visibility reduced)             
        4. big (60% visibility reduced)             
        5. big disspersed(60% visibility reduced)
        6. disspersed progressive(from 5% to 60% visibility reduced)
        7. center progressive(from 5% to 60% visibility reduced)  \n\n"""))

        if (answer==1):
            dirt_over = Image.open("/home/cor21cz/dataset/MidAir/small_dirt_20.png")
        elif(answer==2):
            dirt_over = Image.open("/home/cor21cz/dataset/MidAir/middle_dirt_40.png")
        elif(answer==3):
            dirt_over = Image.open("/home/cor21cz/dataset/MidAir/middle_dirt_40_dispersed.png")
        elif(answer==4):
            dirt_over = Image.open("/home/cor21cz/dataset/MidAir/big_dirt_60.png")
        elif(answer==5):
            dirt_over = Image.open("/home/cor21cz/dataset/MidAir/big_dirt_60_dispersed.png")
        elif(answer==6):
            dirt_over = "disspersed_progressive"
        elif(answer==7):
            dirt_over = "mid_progressive"
        else:
